...
public class PrescriptionRadiotherapieValidatePhysicienAdminInjector{
    ...
    @Bean
    public PrescriptionRadiotherapieValidatePhysicienAdminProcess prescriptionRadiotherapieValidatePhysicienAdmin(PrescriptionRadiotherapieAdminService service) {
        return new PrescriptionRadiotherapieValidatePhysicienAdminProcessImpl(service);
    }
