...
public class PrescriptionRadiotherapieSuivreConsultationAdminInjector{
    ...
    @Bean
    public PrescriptionRadiotherapieSuivreConsultationAdminProcess prescriptionRadiotherapieSuivreConsultationAdmin(PrescriptionRadiotherapieAdminService service) {
        return new PrescriptionRadiotherapieSuivreConsultationAdminProcessImpl(service);
    }
