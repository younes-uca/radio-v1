...
public class PrescriptionRadiotherapieSaveAdminInjector{
    ...
    @Bean
    public PrescriptionRadiotherapieSaveAdminProcess prescriptionRadiotherapieSaveAdmin(PrescriptionRadiotherapieAdminService service) {
        return new PrescriptionRadiotherapieSaveAdminProcessImpl(service);
    }
