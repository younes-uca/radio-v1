...
public class ConsultationRadiotherapieSaveAdminInjector{
    ...
    @Bean
    public ConsultationRadiotherapieSaveAdminProcess consultationRadiotherapieSaveAdmin(ConsultationRadiotherapieAdminService service) {
        return new ConsultationRadiotherapieSaveAdminProcessImpl(service);
    }
