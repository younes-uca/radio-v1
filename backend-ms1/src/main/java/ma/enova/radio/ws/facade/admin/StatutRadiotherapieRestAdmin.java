...
import ma.enova.radio.workflow.admin.process.statutradiotherapie.save.StatutRadiotherapieSaveAdminProcess ;
import ma.enova.radio.workflow.admin.process.statutradiotherapie.save.StatutRadiotherapieSaveAdminInput ;
import ma.enova.radio.workflow.admin.process.statutradiotherapie.save.StatutRadiotherapieSaveAdminOutput ;
...
public class StatutRadiotherapieRestAdmin  extends AbstractController<StatutRadiotherapie, StatutRadiotherapieDto, StatutRadiotherapieHistory, StatutRadiotherapieCriteria, StatutRadiotherapieHistoryCriteria, StatutRadiotherapieAdminService, StatutRadiotherapieConverter> {
    ...
    @ApiOperation("save a statutRadiotherapie")
    @PostMapping("process/save")
    public ResponseEntity<Result<StatutRadiotherapieSaveAdminInput,StatutRadiotherapieSaveAdminOutput>> saveProcess(@RequestBody StatutRadiotherapieSaveAdminInput input) throws Exception {
        StatutRadiotherapieSaveAdminOutput output = new StatutRadiotherapieSaveAdminOutput();
        Result<StatutRadiotherapieSaveAdminInput, StatutRadiotherapieSaveAdminOutput> result = statutRadiotherapieSaveAdminProcess.execute(input, output);
    ...
    @Autowired
    private StatutRadiotherapieSaveAdminProcess statutRadiotherapieSaveAdminProcess;
