...
import ma.enova.radio.workflow.admin.process.histortiqueprescriptionradiotherapie.save.HistortiquePrescriptionRadiotherapieSaveAdminProcess ;
import ma.enova.radio.workflow.admin.process.histortiqueprescriptionradiotherapie.save.HistortiquePrescriptionRadiotherapieSaveAdminInput ;
import ma.enova.radio.workflow.admin.process.histortiqueprescriptionradiotherapie.save.HistortiquePrescriptionRadiotherapieSaveAdminOutput ;
...
public class HistortiquePrescriptionRadiotherapieRestAdmin  extends AbstractController<HistortiquePrescriptionRadiotherapie, HistortiquePrescriptionRadiotherapieDto, HistortiquePrescriptionRadiotherapieHistory, HistortiquePrescriptionRadiotherapieCriteria, HistortiquePrescriptionRadiotherapieHistoryCriteria, HistortiquePrescriptionRadiotherapieAdminService, HistortiquePrescriptionRadiotherapieConverter> {
    ...
    @ApiOperation("save a histortiquePrescriptionRadiotherapie")
    @PostMapping("process/save")
    public ResponseEntity<Result<HistortiquePrescriptionRadiotherapieSaveAdminInput,HistortiquePrescriptionRadiotherapieSaveAdminOutput>> saveProcess(@RequestBody HistortiquePrescriptionRadiotherapieSaveAdminInput input) throws Exception {
        HistortiquePrescriptionRadiotherapieSaveAdminOutput output = new HistortiquePrescriptionRadiotherapieSaveAdminOutput();
        Result<HistortiquePrescriptionRadiotherapieSaveAdminInput, HistortiquePrescriptionRadiotherapieSaveAdminOutput> result = histortiquePrescriptionRadiotherapieSaveAdminProcess.execute(input, output);
    ...
    @Autowired
    private HistortiquePrescriptionRadiotherapieSaveAdminProcess histortiquePrescriptionRadiotherapieSaveAdminProcess;
