...
import ma.enova.radio.workflow.admin.process.typetraitement.save.TypeTraitementSaveAdminProcess ;
import ma.enova.radio.workflow.admin.process.typetraitement.save.TypeTraitementSaveAdminInput ;
import ma.enova.radio.workflow.admin.process.typetraitement.save.TypeTraitementSaveAdminOutput ;
...
public class TypeTraitementRestAdmin  extends AbstractController<TypeTraitement, TypeTraitementDto, TypeTraitementHistory, TypeTraitementCriteria, TypeTraitementHistoryCriteria, TypeTraitementAdminService, TypeTraitementConverter> {
    ...
    @ApiOperation("save a typeTraitement")
    @PostMapping("process/save")
    public ResponseEntity<Result<TypeTraitementSaveAdminInput,TypeTraitementSaveAdminOutput>> saveProcess(@RequestBody TypeTraitementSaveAdminInput input) throws Exception {
        TypeTraitementSaveAdminOutput output = new TypeTraitementSaveAdminOutput();
        Result<TypeTraitementSaveAdminInput, TypeTraitementSaveAdminOutput> result = typeTraitementSaveAdminProcess.execute(input, output);
    ...
    @Autowired
    private TypeTraitementSaveAdminProcess typeTraitementSaveAdminProcess;
