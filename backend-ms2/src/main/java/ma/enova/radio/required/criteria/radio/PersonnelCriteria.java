...
public class PersonnelCriteria extends BaseCriteria {
    ...
    private CategoriePersonnelCriteria categoriePersonnel ;
    private List<CategoriePersonnelCriteria> categoriePersonnels ;
    ...
    public CategoriePersonnelCriteria getCategoriePersonnel(){
        return this.categoriePersonnel;
    }

    public void setCategoriePersonnel(CategoriePersonnelCriteria categoriePersonnel){
        this.categoriePersonnel = categoriePersonnel;
    }
    public List<CategoriePersonnelCriteria> getCategoriePersonnels(){
        return this.categoriePersonnels;
    }

    public void setCategoriePersonnels(List<CategoriePersonnelCriteria> categoriePersonnels){
